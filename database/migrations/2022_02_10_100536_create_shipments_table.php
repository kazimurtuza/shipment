...
class CreateShipmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('shipments', function (Blueprint $table) {
            ...
            $table->decimal('discountpercent',11,2)->nullable();
            $table->decimal('discountamount',11,2)->nullable();
            ...
            $table->date('paid_date')->default(0)->nullable();

            $table->decimal('driver_cost',11,3)->default(0)->nullable();
            $table->decimal('	total_cost',11,3)->default(0)->nullable();
            $table->decimal('	total_profit',11,3)->default(0)->nullable();
            $table->integer('	is_cancel')->default(0)->nullable();
            $table->integer('	is_invoice_submit')->default(0)->nullable();
