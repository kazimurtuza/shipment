...
<p>
    ...
    <br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Estimated miles:{{getmile_with_ex($data_info->distance)}}
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Estimated payment:${{(get_estimate_report_arr($shipment_id)['profit_before_driver']*$driver_info->profit_percentage)/100}}
